...
<section id="contact" class="relative min-h-screen flex items-center justify-center overflow-hidden bg-void noise">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6 text-center" data-aos="fade-up">
        ...
        <h2 class="text-white mb-2" style="font-family:'Space Grotesk',sans-serif; font-weight:700; letter-spacing:-.03em; line-height:.95; font-size:clamp(2.5rem,9vw,8.5rem);">
            SIAP
        </h2>
        <h2 class="mb-2" style="font-family:'Space Grotesk',sans-serif; font-weight:700; letter-spacing:-.03em; line-height:.95; font-size:clamp(1.5rem,5.5vw,7rem);">
            <span class="gold-stroke">BERKOLABORASI</span>
        </h2>
        <h2 class="mb-10" style="font-family:'Space Grotesk',sans-serif; font-weight:700; letter-spacing:-.03em; line-height:.95; font-size:clamp(1.6rem,4.5vw,5rem); color:#333">
            BERSAMA KAMI?
        </h2>
